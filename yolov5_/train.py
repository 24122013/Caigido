...
Tutorial:   https://docs.ultralytics.com/yolov5/tutorials/train_custom_data python train.py --data data.yaml --cfg /models/yolov5s.yaml --batch-size 8 --name Model --epochs 5
